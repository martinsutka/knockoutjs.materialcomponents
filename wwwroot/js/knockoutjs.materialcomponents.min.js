((e,s)=>{"function"==typeof define&&define.amd?define("knockoutjs.materialcomponents",["knockout","material-components-web"],s):s(e.ko,e.mdc)})("undefined"!=typeof self?self:this,(t,i)=>{let a=function(){return this}(),o=t.materialcomponents=t.materialcomponents||{},r=t.materialcomponents.utils=t.materialcomponents.utils||{};r.guid=function(){return a.crypto.randomUUID()},r.throttle=function(i,t){let a=0;return function(...e){var s=(new Date).getTime();s-a<t||(a=s,i(...e))}},r.register=function(e,i,s="template"){o[i.name]=i,t.components.register(e,{template:i[s],viewModel:{createViewModel:(e,s)=>((e=e||{}).element=s.element.querySelector?s.element:s.element.parentElement||s.element.parentNode,new i(e))}})};function e(e){console.debug("Icon()"),this.id=t.isObservable(e.id)?e.id:t.observable(e.id||"_icon_"+r.guid()),this.icon=t.isObservable(e.icon)?e.icon:t.observable(e.icon||""),this.classes=t.isObservable(e.classes)?e.classes:t.observable(e.classes||"")}function s(e){console.debug("CircularProgress()"),this.mdcComponent=null,this.id=t.isObservable(e.id)?e.id:t.observable(e.id||"_circular-progress_"+r.guid()),this.label=t.isObservable(e.label)?e.label:t.observable(e.label||""),this.isOpen=t.isObservable(e.isOpen)?e.isOpen:t.observable("boolean"!=typeof e.isOpen||e.isOpen),this.isDeterminate=t.isObservable(e.isDeterminate)?e.isDeterminate:t.observable("boolean"!=typeof e.isDeterminate||e.isDeterminate),this.progress=t.isObservable(e.progress)?e.progress:t.observable("number"==typeof e.progress?e.progress:0),this.classes=t.isObservable(e.classes)?e.classes:t.observable(e.classes||""),this._isOpenChangedSubscribe=null,this._isDeterminateChangedSubscribe=null,this._progressChangedSubscribe=null}function n(e){console.debug("LinearProgress()"),this.mdcComponent=null,this.id=t.isObservable(e.id)?e.id:t.observable(e.id||"_linear-progress_"+r.guid()),this.label=t.isObservable(e.label)?e.label:t.observable(e.label||""),this.isOpen=t.isObservable(e.isOpen)?e.isOpen:t.observable("boolean"!=typeof e.isOpen||e.isOpen),this.isDeterminate=t.isObservable(e.isDeterminate)?e.isDeterminate:t.observable("boolean"!=typeof e.isDeterminate||e.isDeterminate),this.progress=t.isObservable(e.progress)?e.progress:t.observable("number"==typeof e.progress?e.progress:0),this.buffer=t.isObservable(e.buffer)?e.buffer:t.observable("number"==typeof e.buffer?e.buffer:0),this.classes=t.isObservable(e.classes)?e.classes:t.observable(e.classes||""),this._isOpenChangedSubscribe=null,this._isDeterminateChangedSubscribe=null,this._progressChangedSubscribe=null,this._bufferChangedSubscribe=null}e.prototype.koDescendantsComplete=function(e){e.replaceWith(e.firstElementChild)},e.prototype.dispose=function(){console.log("~Icon()")},e.template='<i class="material-icons" data-bind="text: icon, class: classes, attr: { id: id }"></i>',r.register("mat-icon",e),s.prototype.koDescendantsComplete=function(e){var s=e.firstElementChild;e.replaceWith(s),this.mdcComponent=new i.circularProgress.MDCCircularProgress(s),this._isOpenChangedSubscribe=this.isOpen.subscribe(this._isOpenChanged,this),this._isDeterminateChangedSubscribe=this.isDeterminate.subscribe(this._isDeterminateChanged,this),this._progressChangedSubscribe=this.progress.subscribe(this._progressChanged,this),this.isOpen.valueHasMutated(),this.isDeterminate.valueHasMutated(),this.progress.valueHasMutated()},s.prototype.dispose=function(){console.log("~CircularProgress()"),this._isOpenChangedSubscribe.dispose(),this._isDeterminateChangedSubscribe.dispose(),this._progressChangedSubscribe.dispose(),this.mdcComponent.destroy()},s.prototype._isOpenChanged=function(e){this.mdcComponent[e?"open":"close"]()},s.prototype._isDeterminateChanged=function(e){this.mdcComponent.determinate=e},s.prototype._progressChanged=function(e){this.mdcComponent.progress=e},s.template=`<div class="mdc-circular-progress" style="width:48px;height:48px;" role="progressbar" aria-valuemin="0" aria-valuemax="1"
...
</button>`,r.register("mat-switch",p);function m(e){console.debug("Chip()"),this.mdcComponent=null,this.id=t.isObservable(e.id)?e.id:t.observable(e.id||"_chip_"+r.guid()),this.text=t.isObservable(e.text)?e.text:t.observable(e.text||""),this.icon=t.isObservable(e.icon)?e.icon:t.observable(e.icon||""),this.trailingIcon=t.isObservable(e.trailingIcon)?e.trailingIcon:t.observable(e.trailingIcon||""),this.type=t.isObservable(e.type)?e.type:t.observable(e.type||m.TYPE.regular),this.isChecked=t.isObservable(e.isChecked)?e.isChecked:t.observable("boolean"==typeof e.isChecked&&e.isChecked),this.classes=t.isObservable(e.classes)?e.classes:t.observable(e.classes||""),this.onClick=e.onClick,this.onTrailClick=e.onTrailClick}m.prototype.koDescendantsComplete=function(e){var s=e.firstElementChild;e.replaceWith(s),this.mdcComponent=new i.chips.MDCChip(s),this.mdcComponent.listen("MDCChip:interaction",this._onMdcComponentInteraction.bind(this))},m.prototype.dispose=function(){console.log("~Chip()"),this.mdcComponent.destroy()},m.prototype._onMdcComponentInteraction=function(e){this.type()!==m.TYPE.filter&&this.type()!==m.TYPE.choice||this.isChecked(!this.isChecked()),"function"!=typeof this.onClick?console.debug("Chip : _onClick(): Callback for the 'click' event is not defined."):this.onClick(this)},m.prototype._onMdcComponentTrailingIconInteraction=function(e,s){s.stopPropagation(),"function"!=typeof this.onTrailClick?console.debug("Chip : _onMdcComponentTrailingIconInteraction(): Callback for the 'trailclick' event is not defined."):this.onTrailClick(this)},m.TYPE={regular:0,input:1,filter:2,choice:3},m.template=`<div class="mdc-chip" role="row"
