...
</button>`,s.register("mat-switch",p);function m(e){console.debug("Chip()"),this.mdcComponent=null,this.id=t.isObservable(e.id)?e.id:t.observable(e.id||"_chip_"+s.guid()),this.text=t.isObservable(e.text)?e.text:t.observable(e.text||""),this.icon=t.isObservable(e.icon)?e.icon:t.observable(e.icon||""),this.trailingIcon=t.isObservable(e.trailingIcon)?e.trailingIcon:t.observable(e.trailingIcon||""),this.type=t.isObservable(e.type)?e.type:t.observable(e.type||m.TYPE.regular),this.isChecked=t.isObservable(e.isChecked)?e.isChecked:t.observable("boolean"==typeof e.isChecked&&e.isChecked),this.classes=t.isObservable(e.classes)?e.classes:t.observable(e.classes||""),this.onClick=e.onClick,this.onTrailClick=e.onTrailClick}m.prototype.koDescendantsComplete=function(e){var s=e.firstElementChild;e.replaceWith(s),this.mdcComponent=new i.chips.MDCChip(s),this.mdcComponent.listen("MDCChip:interaction",this._onMdcComponentInteraction.bind(this))},m.prototype.dispose=function(){console.log("~Chip()"),this.mdcComponent.destroy()},m.prototype._onMdcComponentInteraction=function(e){this.type()!==m.TYPE.filter&&this.type()!==m.TYPE.choice||this.isChecked(!this.isChecked()),"function"!=typeof this.onClick?console.debug("Chip : _onClick(): Callback for the 'click' event is not defined."):this.onClick(this)},m.prototype._onMdcComponentTrailingIconInteraction=function(e,s){s.stopPropagation(),"function"!=typeof this.onTrailClick?console.debug("Chip : _onMdcComponentTrailingIconInteraction(): Callback for the 'trailclick' event is not defined."):this.onTrailClick(this)},m.TYPE={regular:0,input:1,filter:2,choice:3},m.template=`<div class="mdc-chip" role="row"
...
</div>`,s.register("mat-range-slider",v)});