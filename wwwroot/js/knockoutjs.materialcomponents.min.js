((e,s)=>{"function"==typeof define&&define.amd?define("knockoutjs.materialcomponents",["knockout","material-components-web"],s):s(e.ko,e.mdc)})("undefined"!=typeof self?self:this,(t,i)=>{let a=function(){return this}(),o=t.materialcomponents=t.materialcomponents||{},s=t.materialcomponents.utils=t.materialcomponents.utils||{};s.guid=function(){return a.crypto.randomUUID()},s.throttle=function(i,t){let a=0;return function(...e){var s=(new Date).getTime();s-a<t||(a=s,i(...e))}},s.register=function(e,i,s="template"){o[i.name]=i,t.components.register(e,{template:i[s],viewModel:{createViewModel:(e,s)=>((e=e||{}).element=s.element.querySelector?s.element:s.element.parentElement||s.element.parentNode,new i(e))}})};function e(e){console.debug("Icon()"),this.id=t.isObservable(e.id)?e.id:t.observable(e.id||"_icon_"+s.guid()),this.icon=t.isObservable(e.icon)?e.icon:t.observable(e.icon||""),this.classes=t.isObservable(e.classes)?e.classes:t.observable(e.classes||"")}function r(e){console.debug("CircularProgress()"),this.mdcComponent=null,this.id=t.isObservable(e.id)?e.id:t.observable(e.id||"_circular-progress_"+s.guid()),this.label=t.isObservable(e.label)?e.label:t.observable(e.label||""),this.isOpen=t.isObservable(e.isOpen)?e.isOpen:t.observable("boolean"!=typeof e.isOpen||e.isOpen),this.isDeterminate=t.isObservable(e.isDeterminate)?e.isDeterminate:t.observable("boolean"!=typeof e.isDeterminate||e.isDeterminate),this.progress=t.isObservable(e.progress)?e.progress:t.observable("number"==typeof e.progress?e.progress:0),this.classes=t.isObservable(e.classes)?e.classes:t.observable(e.classes||""),this._isOpenChangedSubscribe=null,this._isDeterminateChangedSubscribe=null,this._progressChangedSubscribe=null}function c(e){console.debug("LinearProgress()"),this.mdcComponent=null,this.id=t.isObservable(e.id)?e.id:t.observable(e.id||"_linear-progress_"+s.guid()),this.label=t.isObservable(e.label)?e.label:t.observable(e.label||""),this.isOpen=t.isObservable(e.isOpen)?e.isOpen:t.observable("boolean"!=typeof e.isOpen||e.isOpen),this.isDeterminate=t.isObservable(e.isDeterminate)?e.isDeterminate:t.observable("boolean"!=typeof e.isDeterminate||e.isDeterminate),this.progress=t.isObservable(e.progress)?e.progress:t.observable("number"==typeof e.progress?e.progress:0),this.buffer=t.isObservable(e.buffer)?e.buffer:t.observable("number"==typeof e.buffer?e.buffer:0),this.classes=t.isObservable(e.classes)?e.classes:t.observable(e.classes||""),this._isOpenChangedSubscribe=null,this._isDeterminateChangedSubscribe=null,this._progressChangedSubscribe=null,this._bufferChangedSubscribe=null}e.prototype.koDescendantsComplete=function(e){e.replaceWith(e.firstElementChild)},e.prototype.dispose=function(){console.log("~Icon()")},e.template='<i class="material-icons" data-bind="text: icon, class: classes, attr: { id: id }"></i>',s.register("mat-icon",e),r.prototype.koDescendantsComplete=function(e){var s=e.firstElementChild;e.replaceWith(s),this.mdcComponent=new i.circularProgress.MDCCircularProgress(s),this._isOpenChangedSubscribe=this.isOpen.subscribe(this._isOpenChanged,this),this._isDeterminateChangedSubscribe=this.isDeterminate.subscribe(this._isDeterminateChanged,this),this._progressChangedSubscribe=this.progress.subscribe(this._progressChanged,this),this.isOpen.valueHasMutated(),this.isDeterminate.valueHasMutated(),this.progress.valueHasMutated()},r.prototype.dispose=function(){console.log("~CircularProgress()"),this._isOpenChangedSubscribe.dispose(),this._isDeterminateChangedSubscribe.dispose(),this._progressChangedSubscribe.dispose(),this.mdcComponent.destroy()},r.prototype._isOpenChanged=function(e){this.mdcComponent[e?"open":"close"]()},r.prototype._isDeterminateChanged=function(e){this.mdcComponent.determinate=e},r.prototype._progressChanged=function(e){this.mdcComponent.progress=e},r.template=`<div class="mdc-circular-progress" style="width:48px;height:48px;" role="progressbar" aria-valuemin="0" aria-valuemax="1"
...
</div>`,r.templateMedium=`<div class="mdc-circular-progress" style="width:36px;height:36px;" role="progressbar" aria-valuemin="0" aria-valuemax="1"
    data-bind="attr: { id: id, 'aria-label': label }, class: classes">
    <div class="mdc-circular-progress__determinate-container">
...
</div>`,r.templateSmall=`<div class="mdc-circular-progress" style="width:24px;height:24px;" role="progressbar" aria-valuemin="0" aria-valuemax="1"
    data-bind="attr: { id: id, 'aria-label': label }, class: classes">
    <div class="mdc-circular-progress__determinate-container">
