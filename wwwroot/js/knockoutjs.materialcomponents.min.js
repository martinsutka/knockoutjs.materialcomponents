...
</div>`,c.register("mat-radio",f);function y(e){console.debug("TextField()"),this.mdcComponent=null,this.id=t.isObservable(e.id)?e.id:t.observable(e.id||"_textfield_"+c.guid()),this.text=t.isObservable(e.text)?e.text:t.observable(e.text||""),this.note=t.isObservable(e.note)?e.note:t.observable(e.note||""),this.value=t.isObservable(e.value)?e.value:t.observable(e.value||""),this.type=t.isObservable(e.type)?e.type:t.observable(e.type||y.TYPE.text),this.isEnabled=t.isObservable(e.isEnabled)?e.isEnabled:t.observable("boolean"!=typeof e.isEnabled||e.isEnabled),this.prefix=t.isObservable(e.prefix)?e.prefix:t.observable(e.prefix||""),this.suffix=t.isObservable(e.suffix)?e.suffix:t.observable(e.suffix||""),this.min=t.isObservable(e.min)?e.min:t.observable("number"==typeof e.min?e.min:null),this.max=t.isObservable(e.max)?e.max:t.observable("number"==typeof e.max?e.max:null),this.step=t.isObservable(e.step)?e.step:t.observable("number"==typeof e.step?e.step:null),this.classes=t.isObservable(e.classes)?e.classes:t.observable(e.classes||"")}y.prototype.koDescendantsComplete=function(e){var s=e.children[0],i=e.children[1];e.replaceWith(s),s.after(i),this.mdcComponent=new a.textField.MDCTextField(s)},y.prototype.dispose=function(){console.log("~TextField()"),this.mdcComponent.destroy()},y.TYPE={text:"text",number:"number",color:"color",date:"date",time:"time",email:"email",password:"password"},y.template=`<label class="mdc-text-field mdc-text-field--outlined"
