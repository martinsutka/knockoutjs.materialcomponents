...
</div>`,o.register("mat-radio",f);function y(e){console.debug("TextField()"),this.mdcComponent=null,this.id=t.isObservable(e.id)?e.id:t.observable(e.id||"_textfield_"+o.guid()),this.text=t.isObservable(e.text)?e.text:t.observable(e.text||""),this.value=t.isObservable(e.value)?e.value:t.observable(e.value||""),this.type=t.isObservable(e.type)?e.type:t.observable(e.type||y.TYPE.text),this.classes=t.isObservable(e.classes)?e.classes:t.observable(e.classes||"")}y.prototype.koDescendantsComplete=function(e){var s=e.firstElementChild;e.replaceWith(s),this.mdcComponent=new i.textField.MDCTextField(s)},y.prototype.dispose=function(){console.log("~TextField()"),this.mdcComponent.destroy()},y.TYPE={text:"text",number:"number",color:"color",date:"date",time:"time",email:"email",password:"password"},y.template=`<label class="mdc-text-field mdc-text-field--outlined"
