((e,s)=>{"function"==typeof define&&define.amd?define("knockoutjs.materialcomponents",["knockout","material-components-web"],s):s(e.ko,e.mdc)})("undefined"!=typeof self?self:this,(t,i)=>{let a=function(){return this}(),o=t.materialcomponents=t.materialcomponents||{},c=t.materialcomponents.utils=t.materialcomponents.utils||{};c.guid=function(){return a.crypto.randomUUID()},c.throttle=function(i,t){let a=0;return function(...e){var s=(new Date).getTime();s-a<t||(a=s,i(...e))}},c.register=function(e,i,s="template"){o[i.name]=i,t.components.register(e,{template:i[s],viewModel:{createViewModel:(e,s)=>((e=e||{}).element=s.element.querySelector?s.element:s.element.parentElement||s.element.parentNode,new i(e))}})};function e(e){console.debug("Icon()"),this.id=t.isObservable(e.id)?e.id:t.observable(e.id||"_icon_"+c.guid()),this.icon=t.isObservable(e.icon)?e.icon:t.observable(e.icon||""),this.classes=t.isObservable(e.classes)?e.classes:t.observable(e.classes||"")}function s(e){console.debug("CircularProgress()"),this.mdcComponent=null,this.id=t.isObservable(e.id)?e.id:t.observable(e.id||"_circular-progress_"+c.guid()),this.label=t.isObservable(e.label)?e.label:t.observable(e.label||""),this.isOpen=t.isObservable(e.isOpen)?e.isOpen:t.observable("boolean"!=typeof e.isOpen||e.isOpen),this.isDeterminate=t.isObservable(e.isDeterminate)?e.isDeterminate:t.observable("boolean"!=typeof e.isDeterminate||e.isDeterminate),this.progress=t.isObservable(e.progress)?e.progress:t.observable("number"==typeof e.progress?e.progress:0),this.classes=t.isObservable(e.classes)?e.classes:t.observable(e.classes||""),this._isOpenChangedSubscribe=null,this._isDeterminateChangedSubscribe=null,this._progressChangedSubscribe=null}function n(e){console.debug("LinearProgress()"),this.mdcComponent=null,this.id=t.isObservable(e.id)?e.id:t.observable(e.id||"_linear-progress_"+c.guid()),this.label=t.isObservable(e.label)?e.label:t.observable(e.label||""),this.isOpen=t.isObservable(e.isOpen)?e.isOpen:t.observable("boolean"!=typeof e.isOpen||e.isOpen),this.isDeterminate=t.isObservable(e.isDeterminate)?e.isDeterminate:t.observable("boolean"!=typeof e.isDeterminate||e.isDeterminate),this.progress=t.isObservable(e.progress)?e.progress:t.observable("number"==typeof e.progress?e.progress:0),this.buffer=t.isObservable(e.buffer)?e.buffer:t.observable("number"==typeof e.buffer?e.buffer:0),this.classes=t.isObservable(e.classes)?e.classes:t.observable(e.classes||""),this._isOpenChangedSubscribe=null,this._isDeterminateChangedSubscribe=null,this._progressChangedSubscribe=null,this._bufferChangedSubscribe=null}e.prototype.koDescendantsComplete=function(e){e.replaceWith(e.firstElementChild)},e.prototype.dispose=function(){console.log("~Icon()")},e.template='<i class="material-icons" data-bind="text: icon, class: classes, attr: { id: id }"></i>',c.register("mat-icon",e),s.prototype.koDescendantsComplete=function(e){var s=e.firstElementChild;e.replaceWith(s),this.mdcComponent=new i.circularProgress.MDCCircularProgress(s),this._isOpenChangedSubscribe=this.isOpen.subscribe(this._isOpenChanged,this),this._isDeterminateChangedSubscribe=this.isDeterminate.subscribe(this._isDeterminateChanged,this),this._progressChangedSubscribe=this.progress.subscribe(this._progressChanged,this),this.isOpen.valueHasMutated(),this.isDeterminate.valueHasMutated(),this.progress.valueHasMutated()},s.prototype.dispose=function(){console.log("~CircularProgress()"),this._isOpenChangedSubscribe.dispose(),this._isDeterminateChangedSubscribe.dispose(),this._progressChangedSubscribe.dispose(),this.mdcComponent.destroy()},s.prototype._isOpenChanged=function(e){this.mdcComponent[e?"open":"close"]()},s.prototype._isDeterminateChanged=function(e){this.mdcComponent.determinate=e},s.prototype._progressChanged=function(e){this.mdcComponent.progress=e},s.template=`<div class="mdc-circular-progress" style="width:48px;height:48px;" role="progressbar" aria-valuemin="0" aria-valuemax="1"
...
</div>`,c.register("mat-circular-progress",s),c.register("mat-circular-progress-medium",s,"templateMedium"),c.register("mat-circular-progress-small",s,"templateSmall");n.prototype.koDescendantsComplete=function(e){var s=e.firstElementChild;e.replaceWith(s),this.mdcComponent=new i.linearProgress.MDCLinearProgress(s),this._isOpenChangedSubscribe=this.isOpen.subscribe(this._isOpenChanged,this),this._isDeterminateChangedSubscribe=this.isDeterminate.subscribe(this._isDeterminateChanged,this),this._progressChangedSubscribe=this.progress.subscribe(this._progressChanged,this),this._bufferChangedSubscribe=this.buffer.subscribe(this._bufferChanged,this),this.isOpen.valueHasMutated(),this.isDeterminate.valueHasMutated(),this.progress.valueHasMutated(),this.buffer.valueHasMutated()},n.prototype.dispose=function(){console.log("~LinearProgress()"),this._isOpenChangedSubscribe.dispose(),this._isDeterminateChangedSubscribe.dispose(),this._progressChangedSubscribe.dispose(),this._bufferChangedSubscribe.dispose(),this.mdcComponent.destroy()},n.prototype._isOpenChanged=function(e){this.mdcComponent[e?"open":"close"]()},n.prototype._isDeterminateChanged=function(e){this.mdcComponent.determinate=e},n.prototype._progressChanged=function(e){this.mdcComponent.progress=e},n.prototype._bufferChanged=function(e){this.mdcComponent.buffer=e},n.template=`<div role="progressbar" class="mdc-linear-progress" aria-valuemin="0" aria-valuemax="1" aria-valuenow="0"
    data-bind="attr: { id: id, 'aria-label': label }, class: classes">
...
</div>`,c.register("mat-linear-progress",n);function r(e){console.debug("Tooltip()"),this.mdcComponent=null,this.id=t.isObservable(e.id)?e.id:t.observable(e.id||"_tooltip_"+c.guid()),this.classes=t.isObservable(e.classes)?e.classes:t.observable(e.classes||""),this.data=t.isObservable(e.data)?e.data:t.observable(e.data||""),this.showDelay=t.isObservable(e.showDelay)?e.showDelay:t.observable("number"==typeof e.showDelay?e.showDelay:r.SHOW_DELAY),this.hideDelay=t.isObservable(e.hideDelay)?e.hideDelay:t.observable("number"==typeof e.hideDelay?e.hideDelay:r.HIDE_DELAY),this.xPosition=t.isObservable(e.xPosition)?e.xPosition:t.observable(e.xPosition||r.X_POSITION.DETECTED),this.yPosition=t.isObservable(e.yPosition)?e.yPosition:t.observable(e.yPosition||r.Y_POSITION.DETECTED),this.anchor=e.anchor||null,this._showDelayChangedSubscribe=null,this._hideDelayChangedSubscribe=null,this._positionChangedSubscribe=null}r.prototype.koDescendantsComplete=function(e){var s;this.anchor=e.parentElement.querySelector(this.anchor),this.anchor?(this.anchor.setAttribute("aria-describedby",this.id()),a.document.body.append(e),s=e.firstElementChild,e.replaceWith(s),this.mdcComponent=new i.tooltip.MDCTooltip(s),this._showDelayChangedSubscribe=this.showDelay.subscribe(this._showDelayChanged,this),this._hideDelayChangedSubscribe=this.hideDelay.subscribe(this._hideDelayChanged,this),this._positionChangedSubscribe=t.computed(this._positionChanged,this).extend({deferred:!0}),this.showDelay.valueHasMutated(),this.hideDelay.valueHasMutated(),this.xPosition.valueHasMutated(),this.yPosition.valueHasMutated()):console.warn("Tooltip : Missing anchor element for tooltip '%s'.",this.id())},r.prototype.dispose=function(){console.log("~Tooltip()"),this.anchor&&(this._showDelayChangedSubscribe.dispose(),this._hideDelayChangedSubscribe.dispose(),this._positionChangedSubscribe.dispose(),this.mdcComponent.destroy(),this.anchor.removeAttribute("aria-describedby"))},r.prototype._showDelayChanged=function(e){this.mdcComponent.setShowDelay(e)},r.prototype._hideDelayChanged=function(e){this.mdcComponent.setHideDelay(e)},r.prototype._positionChanged=function(){var e=this.xPosition(),s=this.yPosition();t.computedContext.isInitial()||this.mdcComponent.setTooltipPosition({xPos:e,yPos:s})},r.X_POSITION={DETECTED:0,START:1,CENTER:2,END:3,SIDE_START:4,SIDE_END:5},r.Y_POSITION={DETECTED:0,ABOVE:1,BELOW:2,SIDE:3},r.SHOW_DELAY=500,r.HIDE_DELAY=600,r.template=`<div class="mdc-tooltip" role="tooltip" aria-hidden="true"
...
</button>`,c.register("mat-switch",p);function m(e){console.debug("Chip()"),this.mdcComponent=null,this.id=t.isObservable(e.id)?e.id:t.observable(e.id||"_chip_"+c.guid()),this.text=t.isObservable(e.text)?e.text:t.observable(e.text||""),this.icon=t.isObservable(e.icon)?e.icon:t.observable(e.icon||""),this.trailingIcon=t.isObservable(e.trailingIcon)?e.trailingIcon:t.observable(e.trailingIcon||""),this.type=t.isObservable(e.type)?e.type:t.observable(e.type||m.TYPE.regular),this.isChecked=t.isObservable(e.isChecked)?e.isChecked:t.observable("boolean"==typeof e.isChecked&&e.isChecked),this.classes=t.isObservable(e.classes)?e.classes:t.observable(e.classes||""),this.onClick=e.onClick,this.onTrailClick=e.onTrailClick}m.prototype.koDescendantsComplete=function(e){var s=e.firstElementChild;e.replaceWith(s),this.mdcComponent=new i.chips.MDCChip(s),this.mdcComponent.listen("MDCChip:interaction",this._onMdcComponentInteraction.bind(this))},m.prototype.dispose=function(){console.log("~Chip()"),this.mdcComponent.destroy()},m.prototype._onMdcComponentInteraction=function(e){this.type()!==m.TYPE.filter&&this.type()!==m.TYPE.choice||this.isChecked(!this.isChecked()),"function"!=typeof this.onClick?console.debug("Chip : _onClick(): Callback for the 'click' event is not defined."):this.onClick(this)},m.prototype._onMdcComponentTrailingIconInteraction=function(e,s){s.stopPropagation(),"function"!=typeof this.onTrailClick?console.debug("Chip : _onMdcComponentTrailingIconInteraction(): Callback for the 'trailclick' event is not defined."):this.onTrailClick(this)},m.TYPE={regular:0,input:1,filter:2,choice:3},m.template=`<div class="mdc-chip" role="row"
...
</div>`,c.register("mat-chip",m);function v(e){console.debug("Slider()"),this.mdcComponent=null,this.id=t.isObservable(e.id)?e.id:t.observable(e.id||"_slider_"+c.guid()),this.name=t.isObservable(e.name)?e.name:t.observable(e.name||""),this.min=t.isObservable(e.min)?e.min:t.observable("number"==typeof e.min?e.min:0),this.max=t.isObservable(e.max)?e.max:t.observable("number"==typeof e.max?e.max:100),this.value=t.isObservable(e.value)?e.value:t.observable("number"==typeof e.value?e.value:0),this.isEnabled=t.isObservable(e.isEnabled)?e.isEnabled:t.observable("boolean"!=typeof e.isEnabled||e.isEnabled),this.isDiscrete=t.isObservable(e.isDiscrete)?e.isDiscrete:t.observable("boolean"==typeof e.isDiscrete&&e.isDiscrete),this.showTickMarks=t.isObservable(e.showTickMarks)?e.showTickMarks:t.observable("boolean"==typeof e.showTickMarks&&e.showTickMarks),this.classes=t.isObservable(e.classes)?e.classes:t.observable(e.classes||""),this._valueChangedSubscribe=null}function u(e){console.debug("RangeSlider()"),this.mdcComponent=null,this.id=t.isObservable(e.id)?e.id:t.observable(e.id||"_rangeslider_"+c.guid()),this.name=t.isObservable(e.name)?e.name:t.observable(e.name||""),this.minRange=t.isObservable(e.minRange)?e.minRange:t.observable("number"==typeof e.minRange?e.minRange:10),this.min=t.isObservable(e.min)?e.min:t.observable("object"==typeof e.min?e.min:{start:0,end:100}),this.max=t.isObservable(e.max)?e.max:t.observable("object"==typeof e.max?e.max:{start:0,end:100}),this.value=t.isObservable(e.value)?e.value:t.observable(e.value instanceof Array?e.value:[0,0]),this.isEnabled=t.isObservable(e.isEnabled)?e.isEnabled:t.observable("boolean"!=typeof e.isEnabled||e.isEnabled),this.isDiscrete=t.isObservable(e.isDiscrete)?e.isDiscrete:t.observable("boolean"==typeof e.isDiscrete&&e.isDiscrete),this.showTickMarks=t.isObservable(e.showTickMarks)?e.showTickMarks:t.observable("boolean"==typeof e.showTickMarks&&e.showTickMarks),this.classes=t.isObservable(e.classes)?e.classes:t.observable(e.classes||""),this._valueChangedSubscribe=null}v.prototype.koDescendantsComplete=function(e){var s=e.firstElementChild;e.replaceWith(s),this.mdcComponent=new i.slider.MDCSlider(s),this.mdcComponent.listen("MDCSlider:change",this._onMdcComponentChange.bind(this)),this._valueChangedSubscribe=this.value.subscribe(this._valueChanged,this)},v.prototype.dispose=function(){console.log("~Slider()"),this._valueChangedSubscribe.dispose(),this.mdcComponent.destroy()},v.prototype._valueChanged=function(e){this.mdcComponent.setValue(e)},v.prototype._onMdcComponentChange=function(e){this._valueChangedSubscribe.dispose(),this.value(e.detail.value),this._valueChangedSubscribe=this.value.subscribe(this._valueChanged,this)},v.template=`<div class="mdc-slider"
      data-bind="css: {
...
</div>`,c.register("mat-slider",v);u.prototype.koDescendantsComplete=function(e){var s=e.firstElementChild;e.replaceWith(s),this.mdcComponent=new i.slider.MDCSlider(s),this.mdcComponent.listen("MDCSlider:change",this._onMdcComponentChange.bind(this)),this._valueChangedSubscribe=this.value.subscribe(this._valueChanged,this),this.value.valueHasMutated()},u.prototype.dispose=function(){console.log("~RangeSlider()"),this._valueChangedSubscribe.dispose(),this.mdcComponent.destroy()},u.prototype._valueChanged=function(e){this.mdcComponent.setValueStart(e[0]),this.mdcComponent.setValue(e[1])},u.prototype._onMdcComponentChange=function(e){this._valueChangedSubscribe.dispose();var s=this.value();s[1===e.detail.thumb?0:1]=e.detail.value,this.value(s),this._valueChangedSubscribe=this.value.subscribe(this._valueChanged,this)},u.template=`<div class="mdc-slider mdc-slider--range"
      data-bind="css: {
        'mdc-slider--disabled': !isEnabled(),
        'mdc-slider--discrete': isDiscrete,
        'mdc-slider--tick-marks': isDiscrete() && showTickMarks()
