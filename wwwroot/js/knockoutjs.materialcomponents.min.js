...
</div>`,o.register("mat-radio",f);y.prototype.koDescendantsComplete=function(e){var s=e.firstElementChild;e.replaceWith(s),this.mdcComponent=new i.textField.MDCTextField(s)},y.prototype.dispose=function(){console.log("~TextField()"),this.mdcComponent.destroy()},y.template=`<label class="mdc-text-field mdc-text-field--outlined"
        data-bind="attr: { id: id }, class: classes">
...
</label>`,o.register("mat-text-field",y)});